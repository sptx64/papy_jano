...
if selected_module == list_module[0] :
  ...
  if c[0].button("Show dependencies") :
    ...
    for l in links :
      fig.add_trace(go.Scatter(x=l["x"], y=l["y"], mode="markers+lines", marker= dict(size=5,symbol= "arrow-bar-up", angleref="previous"), line_width=1, line_dash="dash", line_color="black", showlegend=False))
